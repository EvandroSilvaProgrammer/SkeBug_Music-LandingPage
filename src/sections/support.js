...
import support from 'assets/images/personal_finance.svg';
import websites from 'assets/images/empty_cart.svg';
...
const data = [
  {
    id: 1,
    icon: websites,
    title: 'Quer comprar as melhores músicas sem sair de casa?',
    description: `Então está no sítio certo! Na nossa plataforma encontrará os álbums (e não só) dos artistas mais badalados do musical angolano.`,
  },
  {
    id: 2,
    icon: support,
    title: 'Quer vender as suas músicas e ter mais noteriedade?',
    description: `Nós somos a solução! Tenha a notoriedade que todo artista deseja alcançar e faça dinheiro no processo.`,
  },
];
