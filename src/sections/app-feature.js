...
import app from 'assets/images/setup_analytics.svg';
        ...
        <Grid sx={styles.grid}>
          <Box sx={styles.rightContent}>
            <SectionHeading
              emoji={emoji}
              sx={styles.heading}
              title="Tenha a tão sonhada visibilidade"
              description="Lhe prometemos uma vasta gama de usuários (potenciais compradores) para alavancar as suas estatísticas, com ferramentas como:"
            />
